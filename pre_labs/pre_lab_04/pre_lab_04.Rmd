...
**Answer** 24 rows, which is what we expect. 
...
**Answer** The county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats is **Prince George's**.
...
maryland_population_with_voters_and_demographics %>%
  ...
  arrange(desc(pct_black_18_plus), desc(pct_dems)) %>% 
...
**Answer** The county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats is **Howard**. This is different from the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats. Howard ranks 8th there. 

```{r}
maryland_population_with_voters_and_demographics %>%
  mutate(pct_asian_18_plus = (pop_asian/pop_18_over)*100, pct_dems = (DEM/Total)*100) %>% 
  arrange(desc(pct_asian_18_plus), desc(pct_dems)) %>% 
