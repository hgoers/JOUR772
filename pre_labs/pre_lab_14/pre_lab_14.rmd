...
**Answer** A dataframe of 999 different press releases. It includes the published date, title, URL, and text for each press release. 
...
**Answer** Finds the unique objects in a vector. 
...
**Answer** We get `r nrow(unique_words) |> scales::comma()` different unique words used in the press release corpus. These unique words are cleaned of non-meaningful syntax, including capitalisations and punctuation. 
...
**Answer** No, we have a lot of stop words at the top of the list.
...
**Answer** Yes! This is better at highlighting his focus topics.  
...
**Answer** 2021 appears to be more focused on COVID, where 2022 appears more focused on community. It is interesting to note that "health" continues to remain high in 2022. 
...
**Task** Run the following code and describe the results.
**Answer** This provides more meaningful topics of discussion. There are some results that suggest we should examine trigrams. 
...
**Task** Run the following code and describe the results.
**Answer** 2022 appears to be more locally focused. Many of the major, national COVID bills, including the American Rescue Plan, were resolved by early in the year, so it is not surprising that they drop off. 
...
**Answer** We get a frequency count of words and their predicted sentiment. Trump is marked as positive, which is interesting (probably because trump is considered to be the verb not the noun). 
