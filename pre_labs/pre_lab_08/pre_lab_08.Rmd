...
**Answer** Take voter registration data by county in Maryland. Then sort it in descending order of the difference between the number of registered voters in 2020 and 2022. Then only view the columns `County` and `TOTAL_DIFF`. Then take the first 10 results. 
...
**Answer** An empty coordinate plane. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar chart of the difference in the number of voters. 
...
**Answer** A bar chart of the difference in the number of voters, ordered by the difference (from smallest to largest).
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** A bar chart of the difference in the number of voters, ordered by the difference (from largest to smallest). It is easier to read the county labels. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** A cleaner plot, with less ink. 
...
**Answer** The plot theme elements have been set to reflect The Economist's style. 
```{r}
maryland_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(County,TOTAL_DIFF), weight=TOTAL_DIFF)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Added meaningful labels: title, x-axis, y-axis, and a caption.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The total number of contributions made in MD by date. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A trend line of the daily total number of contributions. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** We see a more regular interval of dates. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Easier to read date labels.
