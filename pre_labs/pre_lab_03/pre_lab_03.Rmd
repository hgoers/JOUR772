...
**Answer** There were 1,640 problems. There are mixed types of data in each column. 
...
**Answer**: 402,345 results list mail as NA. This represents `r round(402345/476915 * 100, 2)` percent of all results. 
