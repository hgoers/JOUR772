...
**Answer** The headers are unweildy and the data is read in as a character.
...
**Answer** Raw text input to this list, including the names of all committees. 
...
**Answer** A tibble of 57 obs and 1 variable
