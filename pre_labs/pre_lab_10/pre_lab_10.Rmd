...
**Answer** Copy the url of the graphic you published here. It will begin with https://datawrapper.dwcdn.net/. Don't copy the browser's current url. https://datawrapper.dwcdn.net/dx1OB/1/
...
md_gov_county |> 
  ...
  mutate(total = sum(across(cox:write_ins)),
         prop_moore = moore / total * 100) |> 
  write_csv("data/md_gov_county.csv")
```
...
**Answer** Put the URL of your map here. https://datawrapper.dwcdn.net/fKg47/1/
