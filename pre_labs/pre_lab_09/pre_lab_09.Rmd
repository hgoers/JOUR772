...
**Answer** `r colnames(pg_precincts)`
...
**Answer** Precinct-level election-related data and a polygon.  
...
**Answer** A map showing precinct borders. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** 3,234 counties and their details. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Simple feature collection with 24 features and 17 fields describing county-level information for MD. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A county-level map of MD. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map of PG county with the precinct borders displayed. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** We have election turn-out data by precinct in PG County. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Because we appended data to a sf object, we get a simple feature collection with geographic information and interesting turn-out data.  
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map of total eligible voters per precinct. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Eligible voters by county by party. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Population data by county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Map data for MD by county including population data. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe isolating the information we need. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A simple feature with data for a county's population and eligible voters by party. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Fixing the inconsistent naming to make a more clean join. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Simple feature with data on the number of eligible voters per 10000 people in each county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Map of the number of eligible voters per 10000 people in each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A better map with a clearer, more divergent colour scheme. 
...
**Answer** A map showing the number of voters per 10000 people (logged) to show a steeper differential gradient. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Dataframe of number of unaffiliated voters per 10000 people in MD counties. 
...
**Answer** Map of number of unaffiliated voters per 10000 people in MD counties. There aren't any clear regional groupings. 
